    ...
    <>
      <section className="w-full ml-0 m-0 h-fit px-5 pt-20 lg:pl-[320px] gap-7 flex flex-col min-h-screen py-4 justify-center">
        ...
        <div>
          ...
          <p className="text-xl text-stone-600">
            Founded by Nausheen Siddiqui,Hrishabh Aggarwal,Anshita Chaudhary & Saurabh Meena  BidSphere was born out of a passion for
        ...
        <div>
          <p className="text-[#21a9cb] text-xl font-bold mb-3">
